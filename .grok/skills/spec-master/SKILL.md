...
# Spec Master (Grok Build entrypoint)
...
for Grok Build (`.grok/skills/<name>/SKILL.md`), invoked as
...
4. **Running an actual Spec Kit phase**: this repository's Spec Kit
   ...
   `.grok/skills/speckit-<phase>/SKILL.md`. Read that skill and follow it with
