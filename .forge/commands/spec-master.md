...
<!-- Generated entrypoint for Forge — see spec-master/adapters/generic.md -->
...
1. **Argumento**: `{{parameters}}` e o caminho do arquivo de contexto (ex.:
...
4. **Executando uma fase real do Spec Kit**: leia o comando/skill
   `speckit-<fase>` que o Spec Kit instalou em `.forge/commands/` para este
