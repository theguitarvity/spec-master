...
# Spec Master (Command Code entrypoint)
...
for Command Code (`.commandcode/skills/<name>/SKILL.md`), invoked as
...
4. **Running an actual Spec Kit phase**: this repository's Spec Kit
   ...
   `.commandcode/skills/speckit-<phase>/SKILL.md`. Read that skill and follow it with
