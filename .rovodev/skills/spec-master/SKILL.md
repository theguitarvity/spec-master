...
# Spec Master (RovoDev entrypoint)
...
for RovoDev (`.rovodev/skills/<name>/SKILL.md`), invoked as
...
4. **Running an actual Spec Kit phase**: this repository's Spec Kit
   ...
   `.rovodev/skills/speckit-<phase>/SKILL.md`. Read that skill and follow it with
