...
# Spec Master (Alquimia AI entrypoint)
...
for Alquimia AI (`.alquimia/skills/<name>/SKILL.md`), invoked as
...
4. **Running an actual Spec Kit phase**: this repository's Spec Kit
   ...
   `.alquimia/skills/speckit-<phase>/SKILL.md`. Read that skill and follow it with
