...
# Spec Master (Mistral Vibe entrypoint)
...
for Mistral Vibe (`.vibe/skills/<name>/SKILL.md`), invoked as
...
4. **Running an actual Spec Kit phase**: this repository's Spec Kit
   ...
   `.vibe/skills/speckit-<phase>/SKILL.md`. Read that skill and follow it with
